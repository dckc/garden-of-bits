# Boatman: rules verified intuitive and elided

Rules previously stated in `AGENT.md` that the rule-elision-test verified are not load-bearing in our context (typically because Done or another structural section already implies them). Listed for audit; **not loaded into agent context**.
