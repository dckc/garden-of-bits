...
- Roles: `liaison`, `steward`, `monitor`, `review-queue`, `boatman`, `builder`, `assayer`, `cleaner`, `judge`, `assessor`, `stylist`, `archivist`, `curator`, `locksmith`, `saboteur`, `fixer`, `weaver`, `shepherd`, `conductor`, `designer`, `scout`, `botanist`, `major-general`, `gardener`, `evaluator`, `groom`, `investigator`, `journalist`, `librarian`, `scholar`, `timekeeper`. The five jury-seat roles (`assessor`, `stylist`, `archivist`, `curator`, `locksmith`) plus `saboteur` are the default six-seat jury panel that the `judge` dispatches per `skills/pr-creation-flow/SKILL.md` § Jury composition; the orchestrator never dispatches a juror seat directly. The single generic `juror` role was retired in the 2026-05-14 redesign in favor of the named seats.
