...
```sh
git -C /Users/kris/garden/worktrees/endojs-endo-but-for-bots.git fetch origin garden
# Then re-copy roles/, skills/, CLAUDE.md, AGENTS.md from the worktree.
# Replace the commit SHA above and bump `updated:`.
```

The live working tree of the `garden` branch is at `/Users/kris/garden/worktrees/endojs-endo-but-for-bots/integrate--liaison--20260512-194515/` (subject to collection per [`../../WORKTREES.md`](../../WORKTREES.md); the snapshot here is the durable copy).
